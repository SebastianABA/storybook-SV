...
var ReactSelectMaterialUi = (function (_super) {
    ...
    function ReactSelectMaterialUi(props) {
        ...
        _this.getFirstNonUndefined = function (a, b) {
            return (0, isNil_1.default)(a) === false
                ? a
                : (0, isNil_1.default)(b) === false
                    ? b
                    : undefined;
        };
        ...
        _this.getOptionForValue = function (options) {
            return function (value) {
                var option = (0, find_1.default)(options, _this.matchOptionValue(value));
                if ((0, isNil_1.default)(option) === false) {
                    return _this.getSelectOption(option);
                }
                var subOptions = (0, filter_1.default)(options, _this.hasSubOptions);
                if ((0, isEmpty_1.default)(subOptions)) {
                    return;
                }
                return _this.getOptionForValue((0, flatMap_1.default)(subOptions, _this.getSubOption))(value);
            };
        };
        _this.matchOptionValue = function (value) {
            return function (option) {
                if ((0, isString_1.default)(option)) {
                    return value === option;
                }
                return (0, isEqual_1.default)(value, option.value);
            };
        };
        _this.hasSubOptions = function (option) {
            return ((0, isString_1.default)(option) === false && (0, isArray_1.default)(option.options));
        };
        ...
        _this.handleChangeSelect = function (newValue) {
            ...
            if ((0, isFunction_1.default)(onChange)) {
        ...
        _this.handleGotFocus = function (event) {
            ...
            if ((0, isFunction_1.default)(onFocus)) {
                onFocus(event);
            }
        };
        _this.handleLostFocus = function (event) {
            ...
            if ((0, isFunction_1.default)(onBlur)) {
                onBlur(event);
            }
        };
    ...
    ReactSelectMaterialUi.prototype.getOneOrMoreSelectOptions = function (options, value) {
        if ((0, isArray_1.default)(value)) {
            var foundOptions = (0, reject_1.default)((0, map_1.default)(value, this.getOptionForValue(options)), isNil_1.default);
    ...
    ReactSelectMaterialUi.prototype.getOptions = function (options) {
        return (0, map_1.default)(options, this.getSelectOption);
    };
    ...
    ReactSelectMaterialUi.prototype.render = function () {
        ...
        var helperTextId = id && helperText ? "".concat(id, "-helper-text") : undefined;
        ...
        else if ((0, isArray_1.default)(onlyValue) && (0, isEmpty_1.default)(onlyValue)) {
            dropdownOption = null;
        }
        ...
        return ((0, jsx_runtime_1.jsxs)(material_1.FormControl, __assign({ "aria-describedby": helperTextId, className: className, error: error, fullWidth: fullWidth, required: required }, other, { children: [(0, jsx_runtime_1.jsx)(SelectLabel_1.default, { inputId: id, label: label, shrink: shrink, hasInputFocus: hasInputFocus, inputLabelProps: InputLabelProps }), (0, jsx_runtime_1.jsx)(SelectDropdown_1.default, { inputId: id, value: dropdownOption, placeholder: selectPlaceholder, options: this.getOptions(options), selectProps: __assign(__assign({}, SelectProps), { isClearable: isClearable, isDisabled: isDisabled }), hasInputFocus: hasInputFocus, onChange: this.handleChangeSelect, onFocus: this.handleGotFocus, onBlur: this.handleLostFocus }), fullWidth ? undefined : forceMinWidth(label), (0, jsx_runtime_1.jsx)(SelectHelperText_1.default, { id: helperTextId, helperText: helperText, formHelperTextProps: FormHelperTextProps })] })));
    };
    ReactSelectMaterialUi.prototype.isShrinked = function (option) {
        if (this.isShrinkable()) {
            return true;
        }
        if ((0, isArray_1.default)(option)) {
            return (0, isEmpty_1.default)(option) === false;
        }
        return (0, isEmpty_1.default)(option) === false;
    };
    ...
    ReactSelectMaterialUi.prototype.isClearable = function (option) {
        ...
        if ((0, isArray_1.default)(option)) {
            return (0, size_1.default)(option) >= 2;
        }
        return (0, isEmpty_1.default)(option) === false;
    };
    ...
    ReactSelectMaterialUi.prototype.hasFilter = function () {
        return (0, isEmpty_1.default)(this.state.filter) === false;
    };
    ReactSelectMaterialUi.prototype.getValues = function (value) {
        ...
        if ((0, isArray_1.default)(value)) {
            return (0, map_1.default)(value, this.getValue);
        }
...
function forceMinWidth(label) {
    ...
    return (0, jsx_runtime_1.jsx)("span", __assign({ style: style }, { children: label }));
}
