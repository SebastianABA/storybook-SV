...
var mixStyle = function (customStyle, styleFn) {
    return function (base, props) { return (__assign(__assign(__assign({}, base), (typeof customStyle === 'function'
        ? customStyle(base, props)
        : customStyle)), (styleFn ? styleFn(base, props) : {}))); };
};
